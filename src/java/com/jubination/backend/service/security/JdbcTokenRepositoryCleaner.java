package com.jubination.backend.service.security;
 ...
 *
 */
public final class JdbcTokenRepositoryCleaner implements Runnable {
     ...
     */
    public JdbcTokenRepositoryCleaner(JdbcOperations jdbcOperations, long tokenValidityInMs) {
