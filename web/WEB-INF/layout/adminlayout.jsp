...
<div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar" >
            ...
            <li><a style="color:#515151;border-bottom: #c0c0c0 0.5px solid ;border-radius: 5px" href="${pageContext.request.contextPath}/admin/callrecords/get?date=<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%>"><span style="font-size: 20px;"class="glyphicon glyphicon-align-left"></span>&nbsp;Call Records</a></li>  
